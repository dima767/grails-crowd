...
<div id="project-info-box" class="box">
    <g:if test="${mode == 'add'}">
        ...
        <p><label for="description">Description:</label><br/><textarea name="description" cols="53" rows="10"
                id="description">${project?.description}</textarea></p>

        <p><label for="architectureDescription">Architecture description:</label><br/><textarea id="architectureDescription"
    ...
    <g:else>
        ...
        <p><label for="architectureDescription">Architecture description:</label><br/><textarea id="architectureDescription" name="architectureDescription" cols="53" rows="10"
